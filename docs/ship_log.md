...
Looks locked for that drop: Kestrel (approved Wakfu), Ironjaw A2 (fierce helm, dual axes, crimson plate), Gloam proposal B (amber/yellow glowing eyes, wide chilling grin, dual curved silver daggers with gold hilts, purple cloak with gold trim — not the white-eyes sheet), Mender D2 (open cream/gold hood, green lantern staff), Bastion 2C (charcoal and gold, spiked mace, tower shield). Paths are listed at the top of `art/export_2x/characters/README.md`.
...
Headless Godot 4.7.2, 0 failed: motion 2022.
