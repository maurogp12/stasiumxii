...
func _test_live_snapshot_tiles_from_combatsim() -> void:
	...
	eq(SNAPSHOT_TILES.terrain_at(snap, Vector2i(0, 0)), "ground", "default live tile is ground")
	eq(SNAPSHOT_TILES.elevation_at(snap, Vector2i(0, 0)), 0.0, "default live elevation is 0")
