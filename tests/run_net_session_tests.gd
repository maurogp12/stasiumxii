...
func _test_source_stamps() -> void:
	...
	eq(lobby.contains("Mender"), false, "lobby does not hardcode Mender")
	eq(lobby.contains("Gloam"), false, "lobby does not hardcode Gloam")
	eq(lobby.contains("Bastion"), false, "lobby does not hardcode Bastion")
