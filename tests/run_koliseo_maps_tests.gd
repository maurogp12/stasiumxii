...
func _test_original_sheet() -> void:
	...
	truthy(themes.contains("stasium_tileset_electric.png"), "electric sheet is the Stormspire source")
	...
	truthy(storm_water_px.b > storm_water_px.r and storm_water_px.b > storm_water_px.g, "Stormspire water is the purple energy tile")
