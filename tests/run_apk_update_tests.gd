...
func _test_http_and_plan() -> void:
	...
	eq(unread["kind"], "version", "Android without a package version does not guess")
...
func _test_preset_and_sources() -> void:
	...
	for path in ["res://backend/apk_update.gd", "res://backend/apk_install.gd", "res://backend/apk_update_client.gd", "res://scenes/mobile_hub.gd"]:
