...
## Batch 1 walk/attack strips (Kestrel and Ironjaw, SE/NE) load from
## art/grok_project/anims when the files exist. A resolved walk strip replaces
## the hop arc below; missing strips keep the hop and the static facing.
