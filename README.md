...
- Hit bands (Locked, `backend/hit_bands.gd`): 1=90%, 2–3=80%, 4–5=75%, 6–8=70%, 9=65%, 10=60%, 11=55%, 12=50%, 13=45%, 14=40%. The Chebyshev 9–14 soft-block is lifted. Dist past 14 has no invented percent. Out of spell max range stays illegal. Kit damage and hit bands are unchanged.
